...
public abstract class _Trainer extends CayenneDataObject {
    ...
    public void addToSessionArray(Session obj) {
        addToManyTarget("sessionArray", obj, true);
    }
    public void removeFromSessionArray(Session obj) {
        removeToManyTarget("sessionArray", obj, true);
    }
    @SuppressWarnings("unchecked")
    public List<Session> getSessionArray() {
        return (List<Session>)readProperty("sessionArray");
    }
